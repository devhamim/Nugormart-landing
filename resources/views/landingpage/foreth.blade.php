        ...
        <div data-elementor-type="wp-post" data-elementor-id="2325" class="elementor elementor-2325"
            ...
            <div class="elementor-element elementor-element-fe03454 e-con-full e-flex e-con e-parent"
                        ...
                        <div class="elementor-image-carousel-wrapper swiper" dir="ltr">
                            <div class="imageautoplay" aria-live="off">
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image"
                                        src="{{ asset('landingpage/sharee/black-image/1.jpg') }}" alt="1.jpg" />
                                </figure>
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image"
                                        src="{{ asset('landingpage/sharee/black-image/2.jpg') }}" /></figure>
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image"
                                        src="{{ asset('landingpage/sharee/black-image/3.jpg') }}" alt="3.jpg" />
                                </figure>
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image"
                                        src="{{ asset('landingpage/sharee/black-image/4.jpg') }}" alt="4.jpg" />
                                </figure>
                    ...
                    <div class="elementor-widget-container">
                        <div class="elementor-image-carousel-wrapper swiper">
                            <div class="imageautoplay">
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image"
                                        src="{{ asset('landingpage/sharee/black-image/5.jpg') }}" alt="11.jpg" />
                                </figure>
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image"
                                        src="{{ asset('landingpage/sharee/black-image/6.jpg') }}" /></figure>
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image"
                                        src="{{ asset('landingpage/sharee/black-image/7.jpg') }}" alt="33.jpg" />
                                </figure>
                            </div>
                ...
                <div class="elementor-element elementor-element-82347ec elementor-widget__width-initial elementor-widget-mobile__width-initial elementor-widget elementor-widget-heading"
                    data-id="82347ec" data-element_type="widget" data-widget_type="heading.default">
                    <div class="elementor-widget-container">
                        <h2 class="elementor-heading-title elementor-size-default">ফেব্রিক্স পিওর সুতি</h2>
                    </div>
                </div>
                <div class="elementor-element elementor-element-dda0f6e elementor-widget__width-initial elementor-widget-mobile__width-initial elementor-widget elementor-widget-heading"
                    data-id="dda0f6e" data-element_type="widget" data-widget_type="heading.default">
                    <div class="elementor-widget-container">
                        <h2 class="elementor-heading-title elementor-size-default"> ডিজিটাল আফসান প্রিন্ট</h2>
                    </div>
                </div>
                ...
                <div class="elementor-element elementor-element-a428d27 elementor-widget__width-initial elementor-widget elementor-widget-text-editor"
                    ...
                    <div class="elementor-widget-container">
                        ...
                        <p><span style="font-weight: 400;">&#8221;দেখতে অসম্ভব সুন্দর এই জামা, ওড়না, পায়জামা থ্রী পিস
                                সেট </span><span style="font-weight: 400;">খুবই প্রিমিয়াম ও আরামদায়ক&#8221;</span>
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="elementor-widget-container">
                            ...
                            <div class="elementor-wrapper elementor-open-inline">
                                <iframe width="560" height="315"
                                    src="https://www.youtube.com/embed/k2T7WysCw4k?si=EIhRbno-SstDd0zC"
                            ...
                            <div class="elementor-image-carousel-wrapper swiper" dir="ltr">
                                <div class="imageautoplay" aria-live="off">
                                    <figure class="swiper-slide-inner"><img decoding="async"
                                            ...
                                            src="{{ asset('landingpage/sharee/black-image/1.jpg') }}"
                                            alt="1.jpg" /></figure>
                                    <figure class="swiper-slide-inner"><img decoding="async"
                                            class="swiper-slide-image"
                                            src="{{ asset('landingpage/sharee/black-image/3.jpg') }}"
                                            alt="1.jpg" /></figure>
                                    <figure class="swiper-slide-inner"><img decoding="async"
                                            class="swiper-slide-image"
                                            src="{{ asset('landingpage/sharee/black-image/2.jpg') }}"
                                            alt="1.jpg" /></figure>
                                    <figure class="swiper-slide-inner"><img decoding="async"
                                            class="swiper-slide-image"
                                            src="{{ asset('landingpage/sharee/black-image/4.jpg') }}"
                                            alt="1.jpg" /></figure>
                                    <figure class="swiper-slide-inner"><img decoding="async"
                                            class="swiper-slide-image"
                                            src="{{ asset('landingpage/sharee/black-image/6.jpg') }}"
                                            alt="1.jpg" /></figure>
                                    <figure class="swiper-slide-inner"><img decoding="async"
                                            class="swiper-slide-image"
                                            src="{{ asset('landingpage/sharee/black-image/7.jpg') }}"
                                            alt="1.jpg" /></figure>
                                    <figure class="swiper-slide-inner"><img decoding="async"
                                            class="swiper-slide-image"
                                            src="{{ asset('landingpage/sharee/black-image/5.jpg') }}"
                                            alt="1.jpg" /></figure>

                    ...
                    <div class="elementor-widget-container">
                        ...
                        <div class="elementor-image-carousel-wrapper swiper" dir="ltr">
                            <div class="imageautoplay" aria-live="off">
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image" src="{{ asset('landingpage/sharee/nine/1.jpg') }}" /></figure>
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image" src="{{ asset('landingpage/sharee/nine/2.jpg') }}" /></figure>
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image" src="{{ asset('landingpage/sharee/nine/3.jpg') }}" /></figure>
                            </div>
                    ...
                    <div class="elementor-widget-container">
                        <div class="elementor-image-carousel-wrapper swiper">
                            <div class="imageautoplay">
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image" src="{{ asset('landingpage/sharee/nine/4.jpg') }}" /></figure>
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image" src="{{ asset('landingpage/sharee/nine/3.jpg') }}" /></figure>
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image" src="{{ asset('landingpage/sharee/nine/5.jpg') }}" /></figure>
                            </div>

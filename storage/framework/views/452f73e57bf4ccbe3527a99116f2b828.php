                        ...
                        <div class="elementor-widget-container">
                            ...
                            <div class="elementor-wrapper elementor-open-inline">
                                <?php if($products->video): ?>
                                    <iframe width="560" height="315" src="<?php echo e($products->video); ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="elementor-element elementor-element-1eb4728a elementor-headline--style-highlight elementor-widget elementor-widget-animated-headline"
                        ...
                        <div class="elementor-widget-container">
                            ...
                            <h3 class="elementor-headline e-animated">
                                <span style="font-family: 'Hind Siliguri', Sans-serif" class="elementor-headline-plain-text elementor-headline-text-wrapper"><?php echo e($products->name); ?>, রেগুলার প্রাইস </span>
                                <span class="elementor-headline-dynamic-wrapper elementor-headline-text-wrapper">
                                    <span
                                        class="elementor-headline-dynamic-text elementor-headline-text-active"><?php echo e($products->showdiscount); ?>/-</span>
                    ...
                    <div class="elementor-element elementor-element-65994e40 elementor-headline--style-highlight elementor-widget elementor-widget-animated-headline"
                        ...
                        <div class="elementor-widget-container">
                            <h3 class="elementor-headline e-animated">
                                ...
                                <span class="elementor-headline-dynamic-wrapper elementor-headline-text-wrapper">
                                    <span
                                        class="elementor-headline-dynamic-text elementor-headline-text-active"><?php echo e($products->showprice); ?>/-</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 150"
                                        preserveAspectRatio="none">
                                        <path
...
<?php /**PATH F:\all project\landing_nugormart\resources\views/landingpage/ten.blade.php ENDPATH**/ ?>
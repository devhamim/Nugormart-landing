                    ...
                    <div class="elementor-widget-container">
                        ...
                        <div class="elementor-image-carousel-wrapper swiper" dir="ltr">
                            <div class="imageautoplay" aria-live="off">
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image" src="<?php echo e(asset('landingpage/sharee/nine/1.jpg')); ?>" /></figure>
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image" src="<?php echo e(asset('landingpage/sharee/nine/2.jpg')); ?>" /></figure>
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image" src="<?php echo e(asset('landingpage/sharee/nine/3.jpg')); ?>" /></figure>
                            </div>
                    ...
                    <div class="elementor-widget-container">
                        <div class="elementor-image-carousel-wrapper swiper">
                            <div class="imageautoplay">
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image" src="<?php echo e(asset('landingpage/sharee/nine/4.jpg')); ?>" /></figure>
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image" src="<?php echo e(asset('landingpage/sharee/nine/3.jpg')); ?>" /></figure>
                                <figure class="swiper-slide-inner"><img decoding="async" class="swiper-slide-image" src="<?php echo e(asset('landingpage/sharee/nine/5.jpg')); ?>" /></figure>
                            </div>
                        ...
                        <div class="elementor-widget-container">
                            <ul class="elementor-icon-list-items">
                                ...
                                <li class="elementor-icon-list-item">
                                    ...
                                    <span class="elementor-icon-list-text">বডি ৯০" পর্যন্ত বানাতে পারবে।</span>
                                </li>
                                <li class="elementor-icon-list-item">
                                    <span class="elementor-icon-list-icon">
                                        <svg aria-hidden="true" class="e-font-icon-svg e-fas-check-circle"
                                        ...
                                        <div  class="wcf-product-option-wrap wcf-yp-skin-classic wcf-product-option-before-customer">
                                            ...
                                            <p style="padding-top: 20px" class=" address-field form-row-first thwcfd-required thwcfd-field-wrapper thwcfd-field-text wcf-column-100 validate-required" id="billing_address_1_field" data-priority="20">
                                                    ...
                                                    <div class="woocommerce-input-wrapper" style="display: inline-flex">
                                                        <label>
                                                            <input type="checkbox" name="color[]" value="পেস্ট" checked class="input-checkbox">
                                                            পেস্ট
                                                        </label>
                                                        <label>
...
<?php /**PATH F:\all project\batikcloth_fashiongallery\resources\views/landingpage/nine.blade.php ENDPATH**/ ?>
                                        ...
                                        <td>
                                            <?php $__currentLoopData = $inventory->rel_to_attribute; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php if($attribute->weight): ?>
                                                    Package: <?php echo e($attribute->weight); ?>,
                                                <?php endif; ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\all project\batikcloth_fashiongallery\resources\views/backend/product/attributelist.blade.php ENDPATH**/ ?>